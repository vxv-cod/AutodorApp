...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(350, 580)
        Form.setMinimumSize(QtCore.QSize(350, 580))
        ...
        self.plainTextEdit_2.setMinimumSize(QtCore.QSize(0, 25))
        ...
        self.gridLayout.addWidget(self.pushButton_5, 16, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.progressBar_1, 15, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.plainTextEdit_10, 1, 0, 1, 1)

        self.retranslateUi(Form)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(Form)
        Form.setTabOrder(self.plainTextEdit, self.plainTextEdit_2)
        Form.setTabOrder(self.plainTextEdit_2, self.pushButton)
        ...
        Form.setTabOrder(self.pushButton_5, self.plainTextEdit_6)
        ...
        Form.setTabOrder(self.tableWidget_1, self.plainTextEdit_3)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "АвтоВОР"))
        self.plainTextEdit_2.setPlaceholderText(_translate("Form", "Коэффициент относительного уплотнения Купл =  . . ."))
        self.plainTextEdit.setPlaceholderText(_translate("Form", "Расстояние от карьера, км :  . . ."))
        self.pushButton_2.setText(_translate("Form", "2.   ПКЗМ  -->  ВОР_Шаблон"))
        self.pushButton_2.setShortcut(_translate("Form", "Esc"))
        self.plainTextEdit_4.setPlaceholderText(_translate("Form", "ШИФР_ОБЪЕКТА: без учета символов (\"-В-01\", \"-С-01\")"))
        ...
        self.pushButton.setText(_translate("Form", "1.  Robur  -->  ПКЗМ"))
        self.pushButton.setShortcut(_translate("Form", "Esc"))
        self.pushButton_5.setText(_translate("Form", "Редактировать шаблон MS Excel"))
        self.pushButton_5.setShortcut(_translate("Form", "Esc"))
        self.pushButton_3.setText(_translate("Form", "3.  ВОР_Шаблон  -->  ВОР_Итог, Спецификация_Итог"))
        self.pushButton_3.setShortcut(_translate("Form", "Esc"))
        self.pushButton_4.setText(_translate("Form", "4.  Отчёт в MS World"))
        self.pushButton_4.setShortcut(_translate("Form", "Esc"))
        self.plainTextEdit_10.setPlaceholderText(_translate("Form", "Адресс сохранения:  адрес открытого файла Excel от Robur или укажите свою папку . . ."))
